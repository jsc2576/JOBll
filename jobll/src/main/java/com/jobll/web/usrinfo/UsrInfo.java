...
public class UsrInfo implements Serializable{
	...
	private int usr_lv;						// 사용자 등급
	private int tel_num;					// 전화번호
	private int mobile_num;					// 휴대폰번호
	...
	private int act_stus;					// 1:활성 2: 비활성(Default:1)
	private String zip_cd;					// 우편번호
	private String norm_addr;				// 기본주소
	private int dtl_addr;					// 상세주소
	private int usr_birth;					// 생년월일
	...
	public int getAct_stus() {
		return act_stus;
	}
	public void setAct_stus(int act_stus) {
	...
	public int getDtl_addr() {
		return dtl_addr;
	}
	public void setDtl_addr(int dtl_addr) {
		this.dtl_addr = dtl_addr;
	}
	public int getUsr_birth() {
		return usr_birth;
	}
	public void setUsr_birth(int usr_birth) {
