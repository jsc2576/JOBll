        ...
        <div class="col-md-6 col-md-offset-3">
          <form id="usr_make" action = "/usrInfo/usrMdf/send" method="post">
           <div class="form-group">
              <input type="hidden" id="usr_id" name="usr_id" value = ${ entity.usr_id }>
            </div>
           
           
            <div class="form-group">
              <label for="usr_nm">이름</label>
              <input type="text" class="form-control" id="usr_nm" name="usr_nm" placeholder="이름" value = ${ entity.usr_nm }>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="email" class="form-control" id="usr_email"  name="usr_email" placeholder="이메일 주소" value = ${ entity.usr_email }>
            </div>
            <div class="form-group">
              <label for="tel_num">전화번호</label>
               <input type="tel" class="form-control" id="tel_num" name="tel_num" placeholder="- 없이 입력해 주세요" value = ${ entity.tel_num }>
            </div>
            <div class="form-group">
              <label for="mobile_num">핸드폰 번호</label>
               <input type="text" class="form-control" id="mobile_num"  name="mobile_num" placeholder="- 없이 입력해 주세요" value = ${ entity.mobile_num }>
            </div>
