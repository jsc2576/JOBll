...
<div class="body">
	...
	-->
	<form name="tx_editor_form" id="tx_editor_form" action="/atcl/testAtclRun" method="post" accept-charset="utf-8">
		<!-- 에디터 컨테이너 시작 -->
		<div class = "subject-tag">제목 : <input type = "text" class = "subject"></div>
						...
						<div id="tx_richtextbox_menu" class="tx-richtextbox-menu tx-menu">
							...
							<div class="tx-menu-footer">
								<img class="tx-menu-confirm"
									 src="/resources/images/icon/editor/btn_confirm.gif?rv=1.0.1" alt=""/>
								<img class="tx-menu-cancel" hspace="3"
									 src="/resources/images/icon/editor/btn_cancel.gif?rv=1.0.1" alt=""/>
							</div>
						</div>
					</li>
					<li class="tx-list">
	...
	<div id="tx_resizer" class="tx-resize-bar">
		...
		<img id="tx_resize_holder" src="/resources/images/icon/editor/skin/01/btn_drag01.gif" width="58" height="12" unselectable="on" alt="" />
	</div>
					<div class="tx-side-bi" id="tx_side_bi">
		<div style="text-align: right;">
			<img hspace="4" height="14" width="78" align="absmiddle" src="resources/images/icon/editor/editor_bi.png" />
		</div>
	</div>
				<!-- 편집영역 끝 -->
			<!-- 첨부박스 시작 -->
	...
	<div id="tx_attach_div" class="tx-attach-div">
		...
		<div id="tx_attach_box" class="tx-attach-box">
			<div class="tx-attach-box-inner">
				<div id="tx_attach_preview" class="tx-attach-preview"><p></p><img src="/resourcesimages/icon/editor/pn_preview.gif" width="147" height="108" unselectable="on"/></div>
	...
	<div><button onclick='submitdata()'>SAMPLE - submit contents</button></div>
</div>

<!-- 에디터 끝 -->
<script src="resources/js/editorConfig.js" type="text/javascript" charset="utf-8"></script>
