	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
				<li><a href="/dev"><i class="fa fa-dashboard fa-fw"></i>
						Dashboard</a></li>

				<li><a href="/projectInfo/projectInfoList/go"><i
						class="fa fa-th-list fa-fw"></i> Project</a></li>
				<li><a href="/admin/home"><i class="fa fa-lock fa-fw"></i>
						Admin</a>
					<ul class="nav nav-second-level">
						<li><a href="/usrInfo/usrInfoList">사용자 관리</a></li>
						<li><a href="/admin/cmpnyInfo/cnfg">고객사 관리</a></li>

						<li><a href="morris.html">문의 관리</a></li>
